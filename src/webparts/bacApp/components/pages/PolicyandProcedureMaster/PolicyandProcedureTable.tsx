        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                try {
                    ...
                    // Attachment may be a single lookup (or null). Normalize to array of ids.
                    const fileIds = item?.Attachment
                                                ...
                                                <th style={{ minWidth: "75px", maxWidth: "75px" }}>
                                                    <div className="d-flex flex-column bd-highlight">
                                                        ...
                                                        >
                                                            <span>Policy</span>
                                                            <span
                                                                onClick={() => handleSortChange("policytype")}
                                                            >
                                                                <FontAwesomeIcon icon={faSort} />
                                                            </span>
                                                        </div>
                                                        <div className="bd-highlight">
                                                            <input
                                                                ...
                                                                onChange={(e) =>
                                                                    handleFilterChange(e, "policytype")
                                                                }
                                                                className="inputcss"
                                                                style={{ width: "100%" }}
                                                            />
...
export default PolicyandProcedureTable;
