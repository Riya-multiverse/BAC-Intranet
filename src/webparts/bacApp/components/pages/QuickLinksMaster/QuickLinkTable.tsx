...
const QuickLinkTable = ({ onAdd, onEdit, setLoading }: IQuickLinkTableProps) => {
    const sp: SPFI = getSP();
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        // }
          ...
          setQuickLinkData((prev) => prev.filter((n) => n.id !== id));
                ...
                <div className="col-lg-8">
                    <div className="d-flex flex-wrap align-items-center justify-content-end mt-3">
                        <form className="d-flex flex-wrap align-items-center justify-content-start ng-pristine ng-valid">
                            ...
                            <button type="button" className="btn btn-secondary me-1 waves-effect waves-light" onClick={onAdd}> <ArrowLeft size={18} className="me-1" />Back</button>
